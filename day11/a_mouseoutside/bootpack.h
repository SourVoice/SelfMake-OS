...
void sheet_refresh(struct SHTCTL *ctl, struct SHEET *sht, int bx0, int by0, int bx1, int by1); /*从下到上描绘所有图层*/
void sheet_slide(struct SHTCTL *ctl, struct SHEET *sht, int vram_x0, int vram_y0);
void sheet_free(struct SHTCTL *ctl, struct SHEET *sht);                                        /*释放已使用图层空间*/
