        ...
        else
        {
            ...
            else if (fifo8_status(&mousefifo) != 0)
            {
                ...
                if (mouse_decode(&mdec, data) != 0)
                {
                    ...
                    /*移动指针*/
                    boxfill8(vram, xsize, COL8_008484, mid_x, mid_y, mid_x + 15, mid_y + 15); /*隐藏鼠标*/
                    ...
                    boxfill8(vram, xsize, ysize, COL8_008484, 0, 0, 79, 15);   /*隐藏坐标*/
                    putfonts8_asc(vram, xsize, COL8_ffffff, 0, 0, s);          /*显示坐标*/
                    putblock8_8(vram, xsize, 16, 16, mid_x, mid_y, mouse, 16); /*绘制鼠标*/
                }
            }
        }
    }
